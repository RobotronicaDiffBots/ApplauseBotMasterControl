...
//  handController.buffer(10);
  ...
  int[][] applauseBotAngles = {    
    ...
    {1,  155, 153, XBee.GREEN     },          // ApplauseBot 1 - done.
    {2,  155, 156, XBee.RED      },          // ApplauseBot 2 - done.
    {3,  149, 149, XBee.YELLOW    },          // ApplauseBot 3 - done.
    {4,  154, 154, XBee.BLUE     },          // ApplauseBot 4 - done.
    
    {5,  151, 154, XBee.YELLOW   },          // ApplauseBot 5 - done.
    
    {6,  180, 180, XBee.MAGENTA  },          // ApplauseBot 6 - broken.

    {7,  148, 144, XBee.CYAN     },          // ApplauseBot 7 - done.
    {8,  158, 149, XBee.ORANGE   },          // ApplauseBot 8 - done.
    {9,  161, 153, XBee.PURPLE   },          // ApplauseBot 9 - done.

    {10, 180, 180, XBee.TURQUOISE},          // ApplauseBot 10 - broken.
    {11, 180, 180, XBee.RED      }           // ApplauseBot 11 - broken.
  };
    
  // Initialise an array of 10 applausebot objects and lay them out on screen.
